...
public class GradeCheck {
	...
	// A, B, C, D
	// Char grade = scan.next().charAt(0); - use it for scanner
    // if grade is 'A' => then we re printing "Excellent Job! Keep it up!
		//else
		...
		System.out.println("What is your grade?");
		 ...
		 if(grade == 'A') {
			 ...
			 System.out.println("You could earn " +points+ " more points!");
